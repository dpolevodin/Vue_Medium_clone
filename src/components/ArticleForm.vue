                ...
                <div class="col-md-10 offset-md-1 col-xs-12">
                    ...
                    <form @submit.prevent="onSubmit">
                        <fieldset>
                            ...
                            <fieldset class="form-group">
                                <textarea class="form-control form-control-lg" placeholder="What is this article about?" v-model="body">
                                </textarea>
                            </fieldset>
                            ...
                            <fieldset class="form-group">
                                <button type="submit" class="btn btn-lg pull-xs-right btn-primary" disable="isSumitting">
                                    Publish Article
                                </button>
                            </fieldset>
                        </fieldset>
